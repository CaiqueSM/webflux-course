...
class UserServiceTest {
    ...
    void handlerNotFoundTest() {
       ...
       Exception notFound = assertThrows(ObjectNotFoundException.class, () ->service.findById("123").block());
       assertEquals(
               format("Object not found. Id: %s, Type: %s", "123", User.class.getSimpleName()),
               notFound.getMessage()
       );
    }
}